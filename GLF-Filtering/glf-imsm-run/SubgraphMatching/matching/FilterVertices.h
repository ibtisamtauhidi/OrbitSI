...
public:
    ...
    static bool GLFFilter(const Graph* data_graph, const Graph* query_graph, ui** &candidates, ui* &candidates_count, 
    							std::vector<std::vector<ui>> data_orbits, std::vector<std::vector<ui>> query_orbits);
    ...
    static bool DPisoFilter(const Graph *data_graph, const Graph *query_graph, ui **&candidates, ui *&candidates_count,
                            ui *&order, TreeNode *&tree);
    static bool GLFPFilter(const Graph *data_graph, const Graph *query_graph, ui **&candidates, ui *&candidates_count,
                            ui *&order, TreeNode *&tree, std::vector<std::vector<ui>> data_orbits, std::vector<std::vector<ui>> query_orbits);
