...
public:
    ...
    static void generateGLF_HOF_QueryPlan(const Graph *data_graph, const Graph* query_graph, ui *&order, ui *&pivot, std::vector<std::vector<ui>> query_orbits);
    static void generateGLF_DFS_QueryPlan(const Graph *data_graph, const Graph* query_graph, ui *&order, ui *&pivot, std::vector<std::vector<ui>> query_orbits);
